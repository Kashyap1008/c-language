...
struct   Student {
    ...
    int  age;
    char className[20];
    char feesStatus[20]; // To track if fees are submitted or pending
    char parentsName[50];
...
int main() {
    ...
    // Load students from the CSV file when the program starts
    ...
    while(1) {
        ...
        switch(choice) {
            ...
            case 5:
                ...
                saveStudents(students, studentCount); // Save data before exit
                return 0;
            default:
